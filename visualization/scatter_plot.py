...
def plot_grid_cm_tab(title, X, pn, labels=None, plot=True, marker='o', adaptivePN=False, cmap='tab10'):
    """
    ...
    if plot:
        ...
        if nrDim == 2:
            ...
            plt.scatter(X[:, 0], X[:, 1], c=label_color, marker=marker, edgecolors='k', cmap=cmap)
            plt.grid(True)
        if nrDim == 3:
            ax = Axes3D(fig)
            ax.set_xlabel("x")
...
def plot_cm_tab(title, X, labels=None, plot=True, marker='o', alpha=1, cmap='tab10'):
    """
    ...
    if plot:
        ...
        if nrDim == 2:
            ...
            if labels is None:
                ...
                label_color = [l for l in labels]
                plt.scatter(X[:, 0], X[:, 1], c=label_color, marker=marker, edgecolors='k', alpha=alpha, cmap=cmap)
        if nrDim == 3:
            ...
            if labels is None:
                ...
                label_color = [l for l in labels]
                ax.scatter(X[:, 0], X[:, 1], X[:, 2], c=label_color, marker=marker, edgecolors='k', alpha=alpha, cmap=cmap)
